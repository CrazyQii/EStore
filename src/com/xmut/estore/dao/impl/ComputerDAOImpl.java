...
public class ComputerDAOImpl extends BaseDAO<Computer> implements ComputerDAO{
	...
	public Computer getComputer(int id) {
		...
		String sql = "SELECT id,brand,model,price,publishingDate,"+
				"salesAmount,storeNumber,Remark,Url,video_url,syllabus,teacher FROM mycomputers WHERE id = ?";
	...
	public List<Computer> getPageList(CriteriaComputer cc, int pageSize) {
		// TODO Auto-generated method stub
		String sql = "SELECT id,brand,model,price,publishingDate,"+
				"salesAmount,storeNumber,Remark,Url,video_url,syllabus,teacher FROM mycomputers WHERE price BETWEEN ? AND ?"+
				"LIMIT ?,?";
	...
	public List<Computer> getComputerlist() {
		// TODO Auto-generated method stub
		String sql = "SELECT id,brand,model,price,publishingDate,"+
				"salesAmount,storeNumber,Remark,video_url,syllabus,teacher FROM mycomputers";
	...
	//2.
	@Override
	public void updateStock(int id,int storeNumber) {
		// TODO Auto-generated method stub
		String sql = "UPDATE mycomputers SET storeNumber = " +storeNumber+
				" WHERE id = "+id;
		Object [] params = null;
		batch(sql, params);
	}
