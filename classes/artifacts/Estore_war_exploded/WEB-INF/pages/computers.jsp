					...
					<c:forEach items="${computerpage.list }" var="computer">
						  ...
						  <div class="col-sm-6 col-md-4">
							  <a href="computerServlet?method=getComputer&pageNo=${computerpage.pageNo }&id=${computer.id}" >
							  		<div class="thumbnail">
								      <img src="${computer.url }" alt="..." style="width: 100%;">
								      <div class="caption">
								        <h3 style="color:black;overflow: hidden;text-overflow:ellipsis;white-space: nowrap;">${computer.model }</h3><h4 style="color:black;">${computer.brand }</h4>
