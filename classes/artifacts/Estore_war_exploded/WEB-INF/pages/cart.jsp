		...
		<div class="container">
			...
			<table class="table table-striped">
				...
				<c:forEach items = "${sessionScope.ShoppingCart.items }" var = "item">
					...
					<tr>
						<td class="col-md-6 ">
							<img alt="${item.computer.id }" src="${item.computer.teacher }" style="width:130px;height:180px;">
							<span style="font-size: 20px; margin-left: 5rem; ">${item.computer.brand } &nbsp; ${item.computer.model } </span>
						</td>
